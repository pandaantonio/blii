...
export default function DMChatContent({ userId }: DMChatContentProps) {
  ...
  if (peerNotFound || !peer) {
    return (
      <div className="min-h-screen min-h-dvh flex items-center justify-center px-4 text-[#f0ebff] font-['Inter',system-ui,-apple-system,'Segoe_UI',Roboto,sans-serif] bg-[radial-gradient(ellipse_at_20%_20%,#1a0a2e_0%,#0a0618_50%,#2d1045_100%)]">
        <div className="bg-white/2 backdrop-blur-xl border border-white/6 rounded-2xl p-6 sm:p-8 md:p-12 text-center max-w-md w-full">
